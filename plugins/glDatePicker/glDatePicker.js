 ...
 */
 ;(function() {
	...
	$.fn.glDatePicker.defaults =
	{
		...
		prevArrow: '\u25c4',
		nextArrow: '\u25ba',
		//zhanglun add the arguments for dynamic dateString pattern
		pattern :"yyyy-MM-dd",
		...
		onClick: (function(el, cell, date, data,pattern) {
			//el.val(date.toLocaleDateString());
			//zhanglun modify the pattern of the return date String
			var res = pattern;
			var d = date;
			...
			var secomnd = d.getSeconds();if(secomnd<10) secomnd = "0"+secomnd;
	...
	var glDatePicker = (function() {
		...
		glDatePicker.prototype =
		{
			...
			render: function(renderCalback) {
				...
				var monthNames2 = options.monthNames2 || [ '1月', '2月', '3月', '4月', '5月', '6月', '7月', '8月', '9月', '10月', '11月', '12月' ];
